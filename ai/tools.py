    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "city": {
                "type": "string",
                "description": (
                    "Город пользователя для погодного контекста в утренних чек-инах. "
                    "Вызывай когда пользователь называет свой город или переезжает. "
                    "Примеры: 'Варшава', 'Москва', 'Краков', 'Киев'."
                )
            }
        },
        "required": [],
